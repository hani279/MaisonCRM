...
function seedDemoData(db) {
  ...
  const demoClients = [
    ...
    { name: 'Isla Robinson', phone: '0401 234 117', email: 'isla.robinson@example.com', budget_label: '$750,000 - $820,000', stage: 7, status: 'active' },
    { name: 'Oliver Kim', phone: '0401 234 118', email: 'oliver.kim@example.com', budget_label: '$950,000 - $1,050,000', stage: 8, status: 'active', next_action_label: 'Attend Saturday auction', next_action_date: daysFromNow(3), referred_by_partner_id: horizonFinanceId, referral_fee_note: '15% of commission' },
    { name: 'Mia Anderson', phone: '0401 234 119', email: 'mia.anderson@example.com', budget_label: '$700,000 - $760,000', stage: 9, status: 'engaged' },
    { name: 'Lucas Martin', phone: '0401 234 120', email: 'lucas.martin@example.com', budget_label: '$680,000 - $740,000', stage: 10, status: 'engaged', next_action_label: 'Confirm building & pest results', next_action_date: daysFromNow(2) },
    { name: 'Charlotte Lee', phone: '0401 234 121', email: 'charlotte.lee@example.com', budget_label: '$1,200,000+', stage: 11, status: 'engaged', referred_by_partner_id: sydneySettlementsId, referral_fee_note: 'Flat $500 referral fee' },
    { name: 'Henry Davies', phone: '0401 234 122', email: 'henry.davies@example.com', budget_label: '$820,000 - $890,000', stage: 12, status: 'settled', next_action_label: 'Final walkthrough', next_action_date: daysFromNow(4) },
    { name: 'Grace Wilson', phone: '0401 234 123', email: 'grace.wilson@example.com', budget_label: '$730,000 - $790,000', stage: 13, status: 'settled' },
    { name: 'Ethan Brown', phone: '0401 234 124', email: 'ethan.brown@example.com', budget_label: '$880,000 - $940,000', stage: 14, status: 'settled', notes: 'Settled two weeks ago, arranging key handover.' },
    { name: 'Zoe Campbell', phone: '0401 234 125', email: 'zoe.campbell@example.com', budget_label: '$690,000 - $750,000', stage: 14, status: 'settled', notes: 'Handover complete — sending a welcome hamper.' },
